        ...
        <>
            ...
            <div class="flex justify-between flex-col xl:flex-row py-2 w-full gap-2">
                <div
                    ...
                    class="cursor-pointer border  focus:ring-4 focus:outline-none w-full xl:w-1/3 font-medium rounded-lg text-sm px-5 py-2 text-center border-slate-500 text-slate-400 hover:text-white hover:bg-red-600 focus:ring-red-900"
                >
                    Clear
                </div>
                <div
                    onClick={() => setJsonExample()}
                    class="cursor-pointer  border focus:ring-4 focus:outline-none w-full xl:w-1/3 font-medium rounded-lg text-sm px-5 py-2 text-center  border-slate-500 text-slate-400 hover:text-white hover:bg-green-500 focus:ring-green-800"
                >
                    Example
                </div>
                <div
                    onClick={() => sendJsonToP()}
                    class="cursor-pointer border focus:ring-4 focus:outline-none w-full xl:w-1/3 font-medium rounded-lg text-sm px-5 py-2 text-center  border-slate-500 text-slate-400 hover:text-white hover:bg-blue-500 focus:ring-blue-800"
                >
                    Lookup
                </div>
            </div>
