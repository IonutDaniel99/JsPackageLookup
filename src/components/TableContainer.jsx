...
export default function TableContianer({ title, dependencies }) {
  ...
  return (
    <div class="overflow-y-auto overflow-x-auto lg:overflow-x-hidden h-full border-2 rounded-md border-slate-700 scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-slate-900">
                    ...
                    <tr class={`w-full hover:bg-gray-700 ${i() % 2 === 0 ? "bg-gray-800" : "bg-gray-900"}`}>
                      ...
                      <td class="px-6 py-2 text-xs text-center text-stone-200 gap-2" colSpan={4}>
                        <span class="flex items-center justify-center">
                          ...
                          <a href={`https://www.npmjs.com/search?q=${library_name}`} target="_blank" class="text-blue-400">
                            NpmJS.com
                          </a>
                        </span>
                      </td>
              ...
              <td class="py-2 text-center" colSpan={6}>
                <div class="flex justify-between mb-1 w-80 text-center m-auto px-2">
                  ...
                  <span class="text-sm font-medium text-white">
                    {numResolved()} out of {dependencies.length}
                  </span>
                </div>
                <div class="rounded-full h-2.5 bg-gray-700  text-center m-auto w-80">
                  <div
                    class="bg-red-600 h-2.5 rounded-full ease-in duration-700"
                    style={`width: ${returnPercentageForSlider(dependencies, numResolved())}%`}
                  ></div>
                </div>
              </td>
            </tr>
